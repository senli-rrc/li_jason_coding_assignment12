...
const meta: Meta<typeof TableFooter> = {
  ...
  decorators: [
    (Story) => (
      <table style={{ borderCollapse: 'collapse', border: '1px solid #dee2e6' }}>
        <Story />
      </table>
    ),
  ],
...
export const Default: Story = {
  args: {
    children: (
      <tr>
        <td style={{ padding: '0.5rem', border: '1px solid #dee2e6' }}>Total</td>
        <td style={{ padding: '0.5rem', border: '1px solid #dee2e6' }}>3 items</td>
        <td style={{ padding: '0.5rem', border: '1px solid #dee2e6' }}>Summary</td>
      </tr>
    ),
  },
...
export const Disabled: Story = {
  args: {
    ...
    children: (
      <tr>
        <td style={{ padding: '0.5rem', border: '1px solid #dee2e6' }}>Disabled</td>
        <td style={{ padding: '0.5rem', border: '1px solid #dee2e6' }}>Footer</td>
        <td style={{ padding: '0.5rem', border: '1px solid #dee2e6' }}>Content</td>
      </tr>
    ),
  },
  play: async ({ canvasElement }) => {
