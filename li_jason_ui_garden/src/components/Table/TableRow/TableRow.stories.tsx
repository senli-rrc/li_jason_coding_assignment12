...
export const Default: Story = {
  args: {
    children: (
      <>
        <td style={{ padding: '0.5rem', border: '1px solid #dee2e6' }}>John Doe</td>
        <td style={{ padding: '0.5rem', border: '1px solid #dee2e6' }}>john@example.com</td>
        <td style={{ padding: '0.5rem', border: '1px solid #dee2e6' }}>Developer</td>
      </>
    ),
  },
...
export const Disabled: Story = {
  args: {
    ...
    children: (
      <>
        <td style={{ padding: '0.5rem', border: '1px solid #dee2e6' }}>Disabled User</td>
        <td style={{ padding: '0.5rem', border: '1px solid #dee2e6' }}>disabled@example.com</td>
        <td style={{ padding: '0.5rem', border: '1px solid #dee2e6' }}>Inactive</td>
      </>
    ),
  },
  play: async ({ canvasElement }) => {
